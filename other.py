...
best_student = Student('Элла', 'Панаровская', 'your_gender')
bad_student = Student('Фёдор', 'Кучин', 'your_gender')
...
cool_reviewer = Reviewer('Николай', 'Свиридов')
bad_reviewer = Reviewer('Владимир', 'Хомутов')
...
cool_lecturer = Lecturer('Ольга', 'Пичужкина')
bad_lecturer = Lecturer('Олег', 'Гежин')
cool_lecturer.courses_attached += ['Python']
cool_lecturer.courses_attached += ['Git']

best_student.rate_lect(cool_lecturer, 'Python', 9)
best_student.rate_lect(cool_lecturer, 'Python', 5)
